"""Program for vqe_real_amp using official mqt.bench package.
...
ALGORITHM_NAME = "vqe_real_amp"
AVAILABLE_QUBITS = list(range(3, 11))

def build_circuit(n_qubits, measurement=True):
    """Build vqe_real_amp circuit using mqt.bench package.
