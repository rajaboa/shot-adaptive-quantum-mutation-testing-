"""qpeexact program with inline imperative gate construction for QMutPy AST mutation.

Body mirrors upstream mqt.bench `qpeexact.create_circuit`. The final
...
test_cases_official/qpeexact_test_cases.json.
